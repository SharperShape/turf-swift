...
class LineStringTests: XCTestCase {
    ...
    func testLineStringFeature() {
        ...
        let first = Location(latitude: 0, longitude: 0)
        let last = Location(latitude: 10, longitude: 0)
    ...
    func testClosestCoordinate() {
        ...
        var line = [
            Location(latitude: 37.72003306385638, longitude: -122.45717525482178),
            Location(latitude: 37.718242366859215, longitude: -122.45717525482178),
            ]
        let point = Location(latitude: 37.72003306385638, longitude: -122.45717525482178)
        ...
        var points = [
            Location(latitude: 37.72009306385638, longitude: -122.45717525482178),
            Location(latitude: 37.82009306385638, longitude: -122.45717525482178),
            Location(latitude: 37.72009306385638, longitude: -122.45716525482178),
            Location(latitude: 37.72009306385638, longitude: -122.45516525482178),
            ]
        for point in points {
        ...
        line = [
            Location(latitude: 37.72125936929241, longitude: -122.45616137981413),
            Location(latitude: 37.72003306385638, longitude: -122.45717525482178),
            Location(latitude: 37.718242366859215, longitude: -122.45717525482178),
        ]
        points = [
            Location(latitude: 37.71814052497085, longitude: -122.45696067810057),
            Location(latitude: 37.71813203814049, longitude: -122.4573630094528),
            Location(latitude: 37.71797927502795, longitude: -122.45730936527252),
            Location(latitude: 37.71704571582896, longitude: -122.45718061923981),
        ]
        for point in points {
            snapped = Geometry.LineStringRepresentation(line).closestCoordinate(to: point)
        ...
        let lines = [
            ...
            [
                Location(latitude: 31.728167146023935, longitude: 26.279296875),
                Location(latitude: 32.69486597787505, longitude: 21.796875),
                Location(latitude: 29.99300228455108, longitude: 18.80859375),
                Location(latitude: 33.137551192346145, longitude: 12.919921874999998),
                Location(latitude: 35.60371874069731, longitude: 10.1953125),
                Location(latitude: 36.527294814546245, longitude: 4.921875),
                Location(latitude: 36.527294814546245, longitude: -1.669921875),
                Location(latitude: 34.74161249883172, longitude: -5.44921875),
                Location(latitude: 32.99023555965106, longitude: -8.7890625)
            ],
            [
                Location(latitude: 51.52204224896724, longitude: -0.10919809341430663),
                Location(latitude: 51.521942114455435, longitude: -0.10923027992248535),
                Location(latitude: 51.52186200668747, longitude: -0.10916590690612793),
                Location(latitude: 51.52177522311313, longitude: -0.10904788970947266),
                Location(latitude: 51.521601655468345, longitude: -0.10886549949645996),
                Location(latitude: 51.52138135712038, longitude: -0.10874748229980469),
                Location(latitude: 51.5206870765674, longitude: -0.10855436325073242),
                Location(latitude: 51.52027984939518, longitude: -0.10843634605407713),
                Location(latitude: 51.519952729849024, longitude: -0.10839343070983887),
                Location(latitude: 51.51957887606202, longitude: -0.10817885398864746),
                Location(latitude: 51.51928513164789, longitude: -0.10814666748046874),
                Location(latitude: 51.518624199789016, longitude: -0.10789990425109863),
                Location(latitude: 51.51778299991493, longitude: -0.10759949684143065)
            ]
        ];
        for line in lines {
            for point in line {
        ...
        points = [
            Location(latitude: 37.71881098149625, longitude: -122.45702505111694),
            Location(latitude: 37.719235317933844, longitude: -122.45733618736267),
            Location(latitude: 37.72027068864082, longitude: -122.45686411857605),
            Location(latitude: 37.72063561093274, longitude: -122.45652079582213),
        ]
        for point in points {
            let snapped = Geometry.LineStringRepresentation(line).closestCoordinate(to: point)
            XCTAssertNotNil(snapped)
        ...
        let lineString = Geometry.LineStringRepresentation([
            Location(latitude: 49.120689999999996, longitude: -122.65401),
            Location(latitude: 49.120619999999995, longitude: -122.65352),
            Location(latitude: 49.120189999999994, longitude: -122.65237),
        ])
        
        // https://github.com/mapbox/turf-swift/issues/27
        let short = Location(latitude: 49.120403526377203, longitude: -122.6529443631224)
        let long = Location(latitude: 49.120405, longitude: -122.652945)
    ...
    func testCoordinateFromStart() {
        ...
        let line = ((json["geometry"] as! [String: Any])["coordinates"] as! [[Double]]).map { Location(latitude: $0[0], longitude: $0[1]) }
    ...
    func testDistance() {
        let point1 = Location(latitude: 39.984, longitude: -75.343)
        let point2 = Location(latitude: 39.123, longitude: -75.534)
        ...
        let point3 = Location(latitude: 20, longitude: 20)
        let point4 = Location(latitude: 40, longitude: 40)
        ...
        let d = Geometry.LineStringRepresentation(line2).distance(from: Location(latitude: 30, longitude: 30), to: Location(latitude: 40, longitude: 40))!
    ...
    func testSliced() {
        ...
        let line1 = [
            Location(latitude: 22.466878364528448, longitude: -97.88131713867188),
            Location(latitude: 22.175960091218524, longitude: -97.82089233398438),
            Location(latitude: 21.8704201873689, longitude: -97.6190185546875),
            ]
        var start = Location(latitude: 22.254624939561698, longitude: -97.79617309570312)
        var stop = Location(latitude: 22.057641623615734, longitude: -97.72750854492188)
        var sliced = Geometry.LineStringRepresentation(line1).sliced(from: start, to: stop)
        var slicedCoordinates = sliced?.coordinates
        let line1Out = [
            Location(latitude: 22.247393614241204, longitude: -97.83572934173804),
            Location(latitude: 22.175960091218524, longitude: -97.82089233398438),
            Location(latitude: 22.051208078134735, longitude: -97.7384672234217),
            ]
        ...
        let vertical = [
            Location(latitude: 38.70582415504791, longitude: -121.25447809696198),
            Location(latitude: 38.709767459877554, longitude: -121.25449419021606),
            ]
        start = Location(latitude: 38.70582415504791, longitude: -121.25447809696198)
        stop = Location(latitude: 38.70634324369764, longitude: -121.25447809696198)
