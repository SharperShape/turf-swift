...
class MultiPointTests: XCTestCase {
    ...
    func testMultiPointFeature() {
        ...
        let firstCoordinate = Location(latitude: 26.194876675795218, longitude: 14.765625)
        let lastCoordinate = Location(latitude: 24.926294766395593, longitude: 17.75390625)
